# -*- coding: utf-8 -*-
"""
Created on Tue Oct 17 22:19:37 2017
...
# Input files
# =========================================================================
filepath = 'C:\\Users\\rgryan\\Google Drive\\Documents\\PhD\\Data\\Broady_QDOAS_output\\BM_March17_Glyoxal\\'
filepath = 'C:\\Users\\rgryan\\Google Drive\\Documents\\PhD\\Data\\GBR\\MAXDOAS\\R2R_QDOAS\\'
...
file = 'BM_March17_433-458_v2'
file = '24-30Sep_UV_UMconvxs'
fitwindow = '324.5-359'
num_calwindows = 14
...
fontsize = 14
figsize = (20, 3)          
legend_pos = (1,0.5)        #(1.12,1) is good for 15x3 plots 
                             #(1.42,1) is good for 4x3 plots (just 1 day of data)
hourinterval = 12             # x-axis label time interval (hours)
...
def create_EA_dfs(readin_df):
    if one_ref_only:
        ...
        a40 = b90[b90['Elev. viewing angle']>36]
        b40 = b90[b90['Elev. viewing angle']<35]
    
    elif ref_each_scan:
        b90 = readin_df[readin_df['Elev. viewing angle']<80]
        a40 = b90[b90['Elev. viewing angle']>35]  # If ref_each_scan, we won't have   
        b40 = b90[b90['Elev. viewing angle']<35]  #     any 90 deg SCDs    

    a20 = b40[b40['Elev. viewing angle']>15]                  # Now create the rest of the EA
    b20 = b40[b40['Elev. viewing angle']<15]                  #     specific data frames 
    ...
    a2 = b5[b5['Elev. viewing angle']>(1.7+EAoffset)]
    b2 = b5[b5['Elev. viewing angle']<(1.7+EAoffset)]

    a1 = b2[b2['Elev. viewing angle']>(0.7+EAoffset)]
    a0 = b2[b2['Elev. viewing angle']<(0.7+EAoffset)]
    
    if one_ref_only:
        EA_df_list = [a90, a40, a20, a10, a5, a2, a1, a0]
    elif ref_each_scan:
        EA_df_list = [a40, a20, a10, a5, a2, a1, a0]
...
#    plot = plt.figure()
    if plot_VCDs:
        ...
        ylim = ylimit
        if show_error == True:        
            f = a0.plot(x='Date_Time', y=whattoplot, fontsize=fontsize, figsize=figsize, 
                    style='y.', ylim=ylim, yerr=yerror, label='20deg')
        
            a2.plot(x='Date_Time', y=whattoplot, yerr=yerror, ax=f, style='b.', 
            ...
            a40.plot(x='Date_Time', y=whattoplot, yerr=yerror, ax=f, style='r.', 
            ...
            a2.plot(x='Date_Time', y=whattoplot, ax=f, style='b.', 
                    label='3deg', ylim=ylim)
            ...
            a20.plot(x='Date_Time', y=whattoplot, ax=f, style='m.', 
                     label='20deg', ylim=ylim)
            a40.plot(x='Date_Time', y=whattoplot, ax=f, style='r.', 
                     label='30deg', ylim=ylim)
        ...
        f.set_xlim(startdate, enddate)
        #f.xaxis.set_major_locator(x_label_format)
        f.legend(['0deg', '2deg', '5deg', '10deg', '20deg', '40deg'], 
                 loc='center left',
...
if one_ref_only:
    [a90, a40, a20, a10, a5, a2, a1, a0] = create_EA_dfs(readin)
elif ref_each_scan:
    [a40, a20, a10, a5, a2, a1, a0] = create_EA_dfs(readin)
 
plot_tg_results('NO2t', [-0.5e16,0.5e17])
#plot_tg_results('O4', [-2e42,8e43])
plot_tg_results('HCHO', [-0.5e16,0.8e17])
#plot_tg_results('O3t', [-3e19,6e19])
plot_tg_results('RMS', [0.00015,0.002])
...
#plot_tg_results('hono', [-4e15,1e16])
